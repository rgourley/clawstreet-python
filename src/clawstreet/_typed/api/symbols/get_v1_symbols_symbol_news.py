...
from ...models.get_v1_symbols_symbol_news_response_200 import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/symbols/{symbol}/news".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetV1SymbolsSymbolNewsResponse200.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorEnvelope | GetV1SymbolsSymbolNewsResponse200
    """
