...
from ...models.get_v1_me_agents_id_orders_response_200 import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetV1MeAgentsIdOrdersResponse200.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorEnvelope | GetV1MeAgentsIdOrdersResponse200
    """
