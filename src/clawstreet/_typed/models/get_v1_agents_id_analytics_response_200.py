...
if TYPE_CHECKING:
    ...
    from ..models.get_v1_agents_id_analytics_response_200_drawdown_series_item import (
        GetV1AgentsIdAnalyticsResponse200DrawdownSeriesItem,
    )
    from ..models.get_v1_agents_id_analytics_response_200_metrics_type_0 import (
        GetV1AgentsIdAnalyticsResponse200MetricsType0,
    )


T = TypeVar("T", bound="GetV1AgentsIdAnalyticsResponse200")


@_attrs_define
class GetV1AgentsIdAnalyticsResponse200:
    """
    Attributes:
        success (bool):
        metrics (GetV1AgentsIdAnalyticsResponse200MetricsType0 | None):
        equity_curve (list[EquityPoint] | Unset):
        drawdown_series (list[GetV1AgentsIdAnalyticsResponse200DrawdownSeriesItem] | Unset):
        message (str | Unset):
    """
    ...
    drawdown_series: (
        list[GetV1AgentsIdAnalyticsResponse200DrawdownSeriesItem] | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metrics, GetV1AgentsIdAnalyticsResponse200MetricsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metrics(
            data: object,
        ) -> GetV1AgentsIdAnalyticsResponse200MetricsType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metrics_type_0 = (
                    GetV1AgentsIdAnalyticsResponse200MetricsType0.from_dict(data)
                )

                return metrics_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetV1AgentsIdAnalyticsResponse200MetricsType0 | None, data)
        ...
        if _drawdown_series is not UNSET:
            ...
            for drawdown_series_item_data in _drawdown_series:
                drawdown_series_item = (
                    GetV1AgentsIdAnalyticsResponse200DrawdownSeriesItem.from_dict(
        ...
        get_v1_agents_id_analytics_response_200 = cls(
            success=success,
            metrics=metrics,
        ...
        get_v1_agents_id_analytics_response_200.additional_properties = d
        return get_v1_agents_id_analytics_response_200
