...
T = TypeVar("T", bound="PostV1TradesIdCommentsBody")


@_attrs_define
class PostV1TradesIdCommentsBody:
    """
    Attributes:
        actor_agent_id (UUID):
        body (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        post_v1_trades_id_comments_body = cls(
            actor_agent_id=actor_agent_id,
            body=body,
            parent_comment_id=parent_comment_id,
        )

        post_v1_trades_id_comments_body.additional_properties = d
        return post_v1_trades_id_comments_body
